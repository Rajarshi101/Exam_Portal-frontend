...
//       console.log("First question all keys:", Object.keys(questions[0]));
...
//       // Only add if answer is not null/undefined
//       if (answers[questionId]) {
//         formattedAnswers[questionId] = answers[questionId];
//         console.log(`Formatted: ${questionId}: ${answers[questionId]}`);
//       }
//     });
...
//   /* ---------- Trigger Violation with Answers ---------- */
...
//     try {
//       // Format current answers for violation API
//       const currentAnswers = formatAnswersForApi();
      
//       console.log("=== VIOLATION API CALL ===");
//       console.log("Submission ID:", submissionId);
//       console.log("Reason:", reason);
//       console.log("Answers being sent:", currentAnswers);
//       console.log("JSON string:", JSON.stringify(currentAnswers));
      
//       // Call violation API with answers
//       await submitViolation(submissionId, currentAnswers);
...
//       // Note: Backend will handle auto-submit when violations exceed MAX_WARNINGS
//       // No need for frontend auto-submit logic anymore
      
//     } catch (error) {
//       console.error("Error reporting violation:", error);
//       // Even if violation API fails, still update warnings locally
//       const nextWarnings = warnings + 1;
//       setWarnings(nextWarnings);
...
//         const currentAnswers = formatAnswersForApi();
//         console.log("Saving checkpoint with answers:", currentAnswers);
...
//       // Submit answers using regular submit API
...
//       // Submit to backend using regular submit API
//       await submitExamAnswers(submissionId, formattedAnswers);
...
//     console.log("Test - Current formatted answers:", formatted);
//     alert(`Current answers: ${JSON.stringify(formatted)}`);
//   };
...
//   // Get the question ID - use the correct property name based on your data structure
...
//             <label 
//               key={key} 
//               className={`option ${answers[questionId] === key ? "selected" : ""}`}
//             >
//               <input
//                 type="radio"
...
//                 onChange={() => handleOptionSelect(questionId, key)}
//               />
...
//             {warnings >= MAX_WARNINGS 
//               ? "⚠️ MAXIMUM WARNINGS REACHED - Auto-submit triggered by backend"
//               : warnings > 0
